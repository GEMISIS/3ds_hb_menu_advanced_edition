...
exitStatus_t GotoHBMenu()
{
	...
	core_state.Initialize = InitHbMenu;
	core_state.Update = UpdateHbMenu;
	core_state.Render = RenderHBMenu;
	core_state.Destroy = DestroyHBMenu;
	core_state.PostExit = PostExitHBMenu;
